...
def spreadsheet_to_ai(request, posting_id):
    ...
    if homework.is_pending == True:
        ...
        if secret.Is_server:
            ...
            tasks.api_answer(request.user.id, posting_id, ai_models, contents_list, submit_id_list, total_charge, token_num)
...
- 중복되는 내용은 제외.
- 한 문단으로 작성.
위 조건을 토대로 적절한 세부능력 및 특기사항을 기록해줘. 다음부턴 작성 기초 데이터들임.
---다음---
'''
