...
def main(request, room_id):
    classroom = get_object_or_404(models.Classroom, pk=room_id)
...
def peerreview_select_comment(request, submit_id):
    ...
    answer = models.HomeworkAnswer.objects.get(target_profile=profile, contents=answer_key)  # 고른 선택지 객체 가져오기.
