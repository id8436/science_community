...
urlpatterns = [
    ...
    path('data_analysis/draw_graph_table/', data_analysis.draw_graph_table, name='data_analysis_draw_graph_table'),  # 변수 선택
    path('data_analysis/draw_graph/', data_analysis.draw_graph, name='data_analysis_draw_graph'),
    path('data_analysis/fft_analysis/setup', data_analysis.fft_analysis, name='data_analysis_fft_analysis'),
    # 워드클라우드
